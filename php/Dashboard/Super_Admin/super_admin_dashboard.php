...
<head>
    ...
    <title>Kenswed Tech Club - Admin</title>
        ...
        <nav>
            ...
            <div class="nav-links" id="navLinks">
                <ul>
                    ...
                    <li><a href="#">Users</a></li> <!--able to see users, edit, ban, and delete.-->
                    <li><a href="#">Admins</a></li> <!--able to see admin, edit, ban, and delete.--> 
                    <li><a href="#" onclick="confirmLogout()">Logout</a></li>
                </ul>
            </div>
            <i class="fa fa-bars" onclick="toggleMenu()"></i>
        </nav>
        <p id="index" style="text-align: left; margin:10px;">Super-Admin</p>
        <div class="text-box">
